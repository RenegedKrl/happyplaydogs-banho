...
const TopBanner = () => {
  ...
  return (
    <div style={{ background: 'var(--color-secondary)', color: 'var(--color-primary)', padding: '0.5rem 2rem 0.5rem 0.5rem', position: 'relative', zIndex: 101, textAlign: 'center', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap', fontSize: '0.9rem' }}>
      <Gift size={18} />
      <span>OFERTA: Primeiro agendamento = Hidratação Premium Grátis!</span>
      <a href="https://wa.me/5511991249837?text=Ol%C3%A1%21%20Vi%20a%20promo%C3%A7%C3%A3o%20e%20quero%20agendar%20meu%20primeiro%20banho%20com%20hidrata%C3%A7%C3%A3o%20gr%C3%A1tis%21" target="_blank" rel="noreferrer" style={{ textDecoration: 'none', marginLeft: '0.25rem', background: 'var(--color-primary)', color: 'white', padding: '0.2rem 0.6rem', borderRadius: '4px', fontSize: '0.85rem' }}>
        Resgatar
      </a>
